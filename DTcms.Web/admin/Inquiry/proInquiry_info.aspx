<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="proInquiry_info.aspx.cs" Inherits="DTcms.Web.admin.Inquiry.proInquiry_info" %>
  ...
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      <ul class="icon-list">        
        ...
        <li><a href="proInquiry_Adver.aspx">查看推广数据</a></li>
...
<table style="width: 100%;border-collapse: collapse;table-layout: fixed;" border="1" cellspacing="0" cellpadding="0" class="ltable">
  <tr>
    ...
    <th align="center" style="width:55%">汇总</th>
...
<ItemTemplate>
  <tr style=''>
    ...
    <td style="text-align:left"><%#Eval("cityname")%>：<%#Eval("info")%></td>
    <td></td>
  </tr>
</ItemTemplate>
<FooterTemplate>
