<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XMCodes.aspx.cs" Inherits="DTcms.Web.admin.Inquiry.XMCodes" %>
...
<ItemTemplate>
  <tr>
    ...
    <td align="center"><a href="XMCodes.aspx?action=<%#DTEnums.ActionEnum.Edit %>&channel_id=<%#Eval("ID")%>">修改</a></td>
  </tr>
</ItemTemplate>
<FooterTemplate>
