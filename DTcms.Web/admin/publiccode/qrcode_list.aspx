<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="qrcode_list.aspx.cs" Inherits="DTcms.Web.admin.publiccode.qrcode_list" %>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      <ul class="icon-list">     
        <li><a class="add" href="qrcode_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>   
...
<table style="width: 100%;border-collapse: collapse;table-layout: fixed;" border="0" cellspacing="0" cellpadding="0" class="ltable">
  <tr>
    <th width="6%">选择</th>
    <th align="left" width="16%">销售姓名</th>
    <th align="left" width="18%">销售电话</th>
    <th align="left" width="18%">热线电话</th>
    <th align="left" width="18%">位置分类</th>
    <th width="10%">操作</th>
  </tr>
</HeaderTemplate>
<ItemTemplate>
  <tr>
    ...
    <td><%#Eval("SalesPhone")%></td>
    <td><%#Eval("HotLine")%></td>
    <td><%#Eval("QRLocation")%></td>
    <td align="center"><a href="qrcode_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&channel_id=<%#Eval("ID")%>">修改</a></td>
  </tr>
</ItemTemplate>
<FooterTemplate>
