      ...
      <table border="0" cellspacing="0" cellpadding="0" class="border-table" width="98%">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <asp:CheckBoxList ID="cblActionType"  style="width:100%" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow" CssClass="cbllist"></asp:CheckBoxList>
            </td>
            <%--<td align="center"><asp:CheckBoxList ID="chk_IsSHow" runat="server" CssClass="cbllist"></asp:CheckBoxList></td>--%>
          </tr>
          </ItemTemplate>
          </asp:Repeater>
        </tbody>
