...
namespace DTcms.Web.admin.manager
{
    public partial class manager_edit : Web.UI.ManagePage
    {
        ...
        private void ShowInfo(int _id)
        {
            ...
            ddl_CityName.SelectedValue = model.CityName;
            txt_salesCount.Text = Convert.ToString(model.salesCount);
        }
        #endregion
        ...
        private bool DoAdd()
        {
            ...
            model.salesCount = Convert.ToInt32(txt_salesCount.Text.Trim());
            model.CityName = ddl_CityName.SelectedValue;
            if (bll.Add(model) > 0)
            {
