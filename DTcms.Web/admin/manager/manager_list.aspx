...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  <tr>
    ...
    <th align="left" width="12%">销售咨询量(单日)</th>
...
<ItemTemplate>
  <tr>
    ...
    <td><input type="text" style="width:40px" maxlength=5  value="<%# Eval("salesCount")%>" onchange="javascript:Update_salesCount(<%#Eval("id")%>)" id="txt_IC_<%#Eval("id")%>"/></td>
    <td><%# Eval("CityName")%></td>
...
<script type="text/javascript">
    //更新库存数量
    function Update_salesCount(id) {
        var count = $("#txt_IC_" + id).val();
        var type = "MSL";
        $.post("../Ajax/Ajax.aspx", { Type: type, Count: count, ID: id }, function (result) {
            alert("产品编号：" + id + "—更新库存成功！");
        });
    }
</script>
</html>
