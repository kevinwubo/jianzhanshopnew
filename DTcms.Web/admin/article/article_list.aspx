...
<ItemTemplate>
  <tr>
    ...
    <td align="center"><a href="article_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>&page=<%=page%>&keywords=<%=keywords %>">修改</a></td>
  </tr>
</ItemTemplate>
<FooterTemplate>
