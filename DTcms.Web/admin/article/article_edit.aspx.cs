        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            if (action == DTEnums.ActionEnum.Edit.ToString()) //修改
            {
               // ChkAdminLevel("channel_" + this.channel_name + "_list", DTEnums.ActionEnum.Edit.ToString()); //检查权限
                ...
                JscriptMsg("修改信息成功！", "article_list.aspx?channel_id=" + this.channel_id + "&page=" + page + "&keywords=" + keywords, "Success");
            }
            else //添加
            {
                ...
                JscriptMsg("添加信息成功！", "article_list.aspx?channel_id=" + this.channel_id + "&page=" + page + "&keywords=" + keywords, "Success");
            }
        }
    }
}