...
<table style="width: 100%;border-collapse: collapse;table-layout: fixed;" border="0" cellspacing="0" cellpadding="0" class="ltable">
  <tr>
    ...
    <th align="left">广告地址</th>
    <th align="left">广告位置</th>
    <th align="left">广告图片</th>
    <th>操作</th>
  </tr>
</HeaderTemplate>
<ItemTemplate>
  <tr>
    <td align="center"><asp:CheckBox ID="chkId" CssClass="checkall" runat="server" style="vertical-align:middle;" /><asp:HiddenField ID="hidId" Value='<%#Eval("advertID")%>' runat="server" /></td>
    <td><%#Eval("advertTitle")%></td>
    <td><%#Eval("advertUrl")%></td>
    <td><%#Eval("advertPositionText")%></td>
    <td><%#Eval("imageUrl")%></td>
    <td align="center"><a href="advert_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&channel_id=<%#Eval("advertID")%>&page=<%=page %>&keywords=<%=keywords %>">修改</a></td>
  </tr>
</ItemTemplate>
<FooterTemplate>
