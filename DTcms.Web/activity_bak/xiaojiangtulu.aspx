<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="xiaojiangtulu.aspx.cs" Inherits="DTcms.Web.activity.xiaojiangtulu" %>
...
<head>
    <meta charset="utf-8">
    <meta content="小匠图录页" http-equiv="keywords">
    <meta name="description" content="小匠图录页">
...
<div id="guanzhuweixin-s" class="flex-row bg_color_f navheight" style="align-items: center;max-width: 750px">
    ...
    <div class="flex-col texta-c px36 color_57">小匠图录页</div>
...
<img class="w100" style="background:#c90319;padding-top:0.83rem;display: block" src="static/images/315/02.jpg"/>
...
<div class="w100 flex-row" style="position: fixed;height: 0.7rem;bottom:-1px;border-top: 1px solid #fff;max-width: 750px">
    ...
    <a class="flex-col b_itm" href="xiaojiangzhuanchang.aspx?source=<%=Source %>">去小匠拍卖页</a>
...
<script>
    $("#btnSearch").bind("click", function (e) {
        ...
        window.location.href = "xiaojiangtulu.aspx?source=" + source + "&keyword=" + keyword;
    });
    $('.M-box').pagination({
        mode: 'fixed'
    });
