...
namespace DTcms.Web
{
    public partial class urljzz : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
           string str=   DESEncrypt.ConvertBy123("15802148204");

           string str1 = DESEncrypt.ConvertByABC(str);
            //if (IsMobileBrowser())
            //{
            //    Response.Redirect("http://shop.jianzhanjun.com/m_index.html", false);
            //}
            //else
            //{
            //    Response.Redirect("http://shop.jianzhanjun.com/index.html", false);
            //}
