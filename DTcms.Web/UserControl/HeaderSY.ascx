<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HeaderSY.ascx.cs" Inherits="DTcms.Web.UserControl.HeaderSY" %>
...
<header>
	...
	<div class="navBg">
		<nav class="wrap">
			<ul>
				<li><p style="font-family: Microsoft YaHei">建盏主要分类</p>
