<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zhizuntulu.aspx.cs" Inherits="DTcms.Web.activity.zhizuntulu" %>
...
<div class="w100" style="background-color: #c90319;">
    <div class="flex-row mar-l-20 mar-r-20 bg_color_f"
        ...
        <input class="flex-col xj_search texta-l" type="search" id="txt_keywords" placeholder="请输入你要查找的编号（ID）"/>
    </div>
...
<script>
    ...
    $("#btnSearch").bind("click", function (e) {
        ...
        window.location.href = "dashitulu.aspx?source=" + source + "&keyword=" + keyword;
    });
