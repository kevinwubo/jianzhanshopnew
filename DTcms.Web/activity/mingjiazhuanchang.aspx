<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mingjiazhuanchang.aspx.cs" Inherits="DTcms.Web.activity.mingjiazhuanchang" %>
...
<head>
    <meta charset="utf-8">
    <meta content="名家拍卖专场" http-equiv="keywords">
    <meta name="description" content="名家拍卖专场">
...
<div id="guanzhuweixin-s" class="flex-row bg_color_f navheight" style="align-items: center;max-width: 750px">
    ...
    <div class="flex-col texta-c px36 color_57">名家拍卖专场</div>
...
<img class="w100" style="display: block" src="static/images/315/03.jpg"/>
...
<div class="w100" style="background-color: #c90319;">
            ...
            <div class="flex-row" style="flex-direction: column">
                ...
                <div class="flex-row  mar-l-40 mar-r-40 mar-t-16" style="align-items: center">
                    <div class="px24">当前价：</div>
                     ...
                     style="background: #ffc513;height: .5rem;color: white;line-height: .5rem" onclick="alertTiXing('<%=model.ProductID.ToString() %>','<%=model.ProductName %>','<%=model.Author %>','名家')">
                    我要提醒
                </div>
                <%}else
                { %>
                ...
                <div class="flex-row  mar-l-40 mar-r-40 mar-t-16" style="align-items: center">
                    ...
                    <%}else{ %>
                    <div class="w100 texta-c mar-t-16"
                         style="background: #ffc513;height: .5rem;color: white;line-height: .5rem" onclick="alertChuJia('<%=model.ProductID.ToString() %>','<%=model.ProductName %>','<%=model.Author %>','名家','<%=model.CustomerOffer %>','<%=model.HighTelePhone %>','<%=model.MarketPrice%>')">
                        立即出价
                    </div>
                    <%} %>
                <%} %>
    ...
    <input  id="hid_endTime" type="hidden" value="<%=EndTime12 %>"/>
...
<input  id="hid_endTime" type="hidden" value="<%=EndTime11 %>"/>
<div class="w100 flex-row" style="position: fixed;height: 0.7rem;bottom:-1px;border-top: 1px solid #fff;max-width: 750px">
    ...
    <a class="flex-col b_itm b_act" href="mingjiatulu.aspx?source=<%=Source %>">去图录页</a>
</div>
...
<script>
    ...
    $("#btnSearch").bind("click", function (e) {
        ...
        window.location.href = "mingjiazhuanchang.aspx?source=" + source + "&keyword=" + keyword;
    });
    $('.M-box').pagination({
        mode: 'fixed'
    });
