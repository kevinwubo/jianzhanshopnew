...
{
    public partial class xiaojiangtulu : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
           ...
           ModelList = bll.GetProductList(" and ProductID in(" + bllCodes.GetModel(" and Code='315XIAOJIANG'").CodeValues + ") ", 100);//小匠专场
           ...
           try
           {
               ...
               {
                   sb.Append("<a href='xiaojiangtulu.aspx?page=" + i + "&source=" + Source + "''>" + i + "</a>"); 
                   //xiaojiangtulu_julebu_1.html
                   //sb.Append("<a href='xiaojiangtulu_" + Source + "_" + i + ".html'>" + i + "</a>");     
               }
