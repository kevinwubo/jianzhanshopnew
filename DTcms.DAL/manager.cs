...
namespace DTcms.DAL
{
    ...
    public partial class manager
    {
        ...
        public int Add(Model.manager model)
        {
            ...
            strSql.Append("role_id,role_type,user_name,password,salt,real_name,telephone,email,is_lock,add_time,salesCount,CityName)");
            ...
            parameters[10].Value = model.salesCount;
        ...
        /// 更新一条数据
        /// </summary>
        public bool UpdateSalesCountByID(int id, int salesCount)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public bool Update(Model.manager model)
        {
            ...
            parameters[7].Value = model.email;
            parameters[8].Value = model.is_lock;
            parameters[9].Value = model.salesCount;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,role_id,role_type,user_name,password,salt,real_name,telephone,email,is_lock,add_time,salesCount,CityName from " + databaseprefix + "manager ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
        ...
        /// 根据用户名密码返回一个实体
        /// </summary>
        public Model.manager GetModel(string real_name)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id from " + databaseprefix + "manager");
            strSql.Append(" where real_name=@real_name ");
            SqlParameter[] parameters = {
					new SqlParameter("@real_name", SqlDbType.NVarChar,100)};
            parameters[0].Value = real_name;
